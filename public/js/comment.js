const newCommentFormHandler = async (event) => {
    ...
    console.log('clicked Post!__________________________________________________');
      ...
      const blog_id = document.querySelector("#postId").dataset.blogid;
      ...
      const response = await fetch("/api/blog/comment", {
        ...
        body: JSON.stringify({ commentPost, blog_id}),
        headers: {
